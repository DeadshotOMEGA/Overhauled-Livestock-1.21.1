...
//        simpleItem(LOItems.COVERED_WAGON);
        ...
        simpleItem(LOItems.BLACK_ACCENTED_SADDLE);
        simpleItem(LOItems.BLUE_ACCENTED_SADDLE);
        simpleItem(LOItems.BROWN_ACCENTED_SADDLE);
        simpleItem(LOItems.CYAN_ACCENTED_SADDLE);
        simpleItem(LOItems.GREEN_ACCENTED_SADDLE);
        simpleItem(LOItems.GREY_ACCENTED_SADDLE);
        simpleItem(LOItems.LIGHT_BLUE_ACCENTED_SADDLE);
        simpleItem(LOItems.LIGHT_GREY_ACCENTED_SADDLE);
        simpleItem(LOItems.LIME_ACCENTED_SADDLE);
        simpleItem(LOItems.MAGENTA_ACCENTED_SADDLE);
        simpleItem(LOItems.ORANGE_ACCENTED_SADDLE);
        simpleItem(LOItems.PINK_ACCENTED_SADDLE);
        simpleItem(LOItems.PURPLE_ACCENTED_SADDLE);
        simpleItem(LOItems.RED_ACCENTED_SADDLE);
        simpleItem(LOItems.WHITE_ACCENTED_SADDLE);
        simpleItem(LOItems.YELLOW_ACCENTED_SADDLE);
        simpleItem(LOItems.BLACK_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.BLUE_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.BROWN_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.CYAN_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.GREEN_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.GREY_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.LIGHT_BLUE_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.LIGHT_GREY_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.LIME_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.MAGENTA_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.ORANGE_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.PINK_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.PURPLE_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.RED_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.WHITE_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.YELLOW_ACCENTED_LIGHT_SADDLE);
        simpleItem(LOItems.BLACK_ACCENTED_HEAVY_SADDLE);
        simpleItem(LOItems.BLUE_ACCENTED_HEAVY_SADDLE);
        simpleItem(LOItems.BROWN_ACCENTED_HEAVY_SADDLE);
        simpleItem(LOItems.CYAN_ACCENTED_HEAVY_SADDLE);
        simpleItem(LOItems.GREEN_ACCENTED_HEAVY_SADDLE);
        simpleItem(LOItems.GREY_ACCENTED_HEAVY_SADDLE);
        simpleItem(LOItems.LIGHT_BLUE_ACCENTED_HEAVY_SADDLE);
        simpleItem(LOItems.LIGHT_GREY_ACCENTED_HEAVY_SADDLE);
        simpleItem(LOItems.LIME_ACCENTED_HEAVY_SADDLE);
        simpleItem(LOItems.MAGENTA_ACCENTED_HEAVY_SADDLE);
        simpleItem(LOItems.ORANGE_ACCENTED_HEAVY_SADDLE);
        simpleItem(LOItems.PINK_ACCENTED_HEAVY_SADDLE);
        simpleItem(LOItems.PURPLE_ACCENTED_HEAVY_SADDLE);
        simpleItem(LOItems.RED_ACCENTED_HEAVY_SADDLE);
        simpleItem(LOItems.WHITE_ACCENTED_HEAVY_SADDLE);
        simpleItem(LOItems.YELLOW_ACCENTED_HEAVY_SADDLE);

        simpleItem(LOItems.BLUE_ACCENTED_BLACK_SADDLE);
        simpleItem(LOItems.BROWN_ACCENTED_BLACK_SADDLE);
        simpleItem(LOItems.CYAN_ACCENTED_BLACK_SADDLE);
        simpleItem(LOItems.GREEN_ACCENTED_BLACK_SADDLE);
        simpleItem(LOItems.GREY_ACCENTED_BLACK_SADDLE);
        simpleItem(LOItems.LIGHT_BLUE_ACCENTED_BLACK_SADDLE);
        simpleItem(LOItems.LIGHT_GREY_ACCENTED_BLACK_SADDLE);
        simpleItem(LOItems.LIME_ACCENTED_BLACK_SADDLE);
        simpleItem(LOItems.MAGENTA_ACCENTED_BLACK_SADDLE);
        simpleItem(LOItems.ORANGE_ACCENTED_BLACK_SADDLE);
        simpleItem(LOItems.PINK_ACCENTED_BLACK_SADDLE);
        simpleItem(LOItems.PURPLE_ACCENTED_BLACK_SADDLE);
        simpleItem(LOItems.RED_ACCENTED_BLACK_SADDLE);
        simpleItem(LOItems.WHITE_ACCENTED_BLACK_SADDLE);
        simpleItem(LOItems.YELLOW_ACCENTED_BLACK_SADDLE);
        simpleItem(LOItems.BLUE_ACCENTED_BLACK_LIGHT_SADDLE);
        simpleItem(LOItems.BROWN_ACCENTED_BLACK_LIGHT_SADDLE);
        simpleItem(LOItems.CYAN_ACCENTED_BLACK_LIGHT_SADDLE);
        simpleItem(LOItems.GREEN_ACCENTED_BLACK_LIGHT_SADDLE);
        simpleItem(LOItems.GREY_ACCENTED_BLACK_LIGHT_SADDLE);
        simpleItem(LOItems.LIGHT_BLUE_ACCENTED_BLACK_LIGHT_SADDLE);
        simpleItem(LOItems.LIGHT_GREY_ACCENTED_BLACK_LIGHT_SADDLE);
        simpleItem(LOItems.LIME_ACCENTED_BLACK_LIGHT_SADDLE);
        simpleItem(LOItems.MAGENTA_ACCENTED_BLACK_LIGHT_SADDLE);
        simpleItem(LOItems.ORANGE_ACCENTED_BLACK_LIGHT_SADDLE);
        simpleItem(LOItems.PINK_ACCENTED_BLACK_LIGHT_SADDLE);
        simpleItem(LOItems.PURPLE_ACCENTED_BLACK_LIGHT_SADDLE);
        simpleItem(LOItems.RED_ACCENTED_BLACK_LIGHT_SADDLE);
        simpleItem(LOItems.WHITE_ACCENTED_BLACK_LIGHT_SADDLE);
        simpleItem(LOItems.YELLOW_ACCENTED_BLACK_LIGHT_SADDLE);
        simpleItem(LOItems.BLUE_ACCENTED_BLACK_HEAVY_SADDLE);
        simpleItem(LOItems.BROWN_ACCENTED_BLACK_HEAVY_SADDLE);
        simpleItem(LOItems.CYAN_ACCENTED_BLACK_HEAVY_SADDLE);
        simpleItem(LOItems.GREEN_ACCENTED_BLACK_HEAVY_SADDLE);
        simpleItem(LOItems.GREY_ACCENTED_BLACK_HEAVY_SADDLE);
        simpleItem(LOItems.LIGHT_BLUE_ACCENTED_BLACK_HEAVY_SADDLE);
        simpleItem(LOItems.LIGHT_GREY_ACCENTED_BLACK_HEAVY_SADDLE);
        simpleItem(LOItems.LIME_ACCENTED_BLACK_HEAVY_SADDLE);
        simpleItem(LOItems.MAGENTA_ACCENTED_BLACK_HEAVY_SADDLE);
        simpleItem(LOItems.ORANGE_ACCENTED_BLACK_HEAVY_SADDLE);
        simpleItem(LOItems.PINK_ACCENTED_BLACK_HEAVY_SADDLE);
        simpleItem(LOItems.PURPLE_ACCENTED_BLACK_HEAVY_SADDLE);
        simpleItem(LOItems.RED_ACCENTED_BLACK_HEAVY_SADDLE);
        simpleItem(LOItems.WHITE_ACCENTED_BLACK_HEAVY_SADDLE);
        simpleItem(LOItems.YELLOW_ACCENTED_BLACK_HEAVY_SADDLE);

        simpleItem(LOItems.BLACK_ACCENTED_WHITE_SADDLE);
        simpleItem(LOItems.BLUE_ACCENTED_WHITE_SADDLE);
        simpleItem(LOItems.BROWN_ACCENTED_WHITE_SADDLE);
        simpleItem(LOItems.CYAN_ACCENTED_WHITE_SADDLE);
        simpleItem(LOItems.GREEN_ACCENTED_WHITE_SADDLE);
        simpleItem(LOItems.GREY_ACCENTED_WHITE_SADDLE);
        simpleItem(LOItems.LIGHT_BLUE_ACCENTED_WHITE_SADDLE);
        simpleItem(LOItems.LIGHT_GREY_ACCENTED_WHITE_SADDLE);
        simpleItem(LOItems.LIME_ACCENTED_WHITE_SADDLE);
        simpleItem(LOItems.MAGENTA_ACCENTED_WHITE_SADDLE);
        simpleItem(LOItems.ORANGE_ACCENTED_WHITE_SADDLE);
        simpleItem(LOItems.PINK_ACCENTED_WHITE_SADDLE);
        simpleItem(LOItems.PURPLE_ACCENTED_WHITE_SADDLE);
        simpleItem(LOItems.RED_ACCENTED_WHITE_SADDLE);
        simpleItem(LOItems.YELLOW_ACCENTED_WHITE_SADDLE);
        simpleItem(LOItems.BLACK_ACCENTED_WHITE_LIGHT_SADDLE);
        simpleItem(LOItems.BLUE_ACCENTED_WHITE_LIGHT_SADDLE);
        simpleItem(LOItems.BROWN_ACCENTED_WHITE_LIGHT_SADDLE);
        simpleItem(LOItems.CYAN_ACCENTED_WHITE_LIGHT_SADDLE);
        simpleItem(LOItems.GREEN_ACCENTED_WHITE_LIGHT_SADDLE);
        simpleItem(LOItems.GREY_ACCENTED_WHITE_LIGHT_SADDLE);
        simpleItem(LOItems.LIGHT_BLUE_ACCENTED_WHITE_LIGHT_SADDLE);
        simpleItem(LOItems.LIGHT_GREY_ACCENTED_WHITE_LIGHT_SADDLE);
        simpleItem(LOItems.LIME_ACCENTED_WHITE_LIGHT_SADDLE);
        simpleItem(LOItems.MAGENTA_ACCENTED_WHITE_LIGHT_SADDLE);
        simpleItem(LOItems.ORANGE_ACCENTED_WHITE_LIGHT_SADDLE);
        simpleItem(LOItems.PINK_ACCENTED_WHITE_LIGHT_SADDLE);
        simpleItem(LOItems.PURPLE_ACCENTED_WHITE_LIGHT_SADDLE);
        simpleItem(LOItems.RED_ACCENTED_WHITE_LIGHT_SADDLE);
        simpleItem(LOItems.YELLOW_ACCENTED_WHITE_LIGHT_SADDLE);
        simpleItem(LOItems.BLACK_ACCENTED_WHITE_HEAVY_SADDLE);
        simpleItem(LOItems.BLUE_ACCENTED_WHITE_HEAVY_SADDLE);
        simpleItem(LOItems.BROWN_ACCENTED_WHITE_HEAVY_SADDLE);
        simpleItem(LOItems.CYAN_ACCENTED_WHITE_HEAVY_SADDLE);
        simpleItem(LOItems.GREEN_ACCENTED_WHITE_HEAVY_SADDLE);
        simpleItem(LOItems.GREY_ACCENTED_WHITE_HEAVY_SADDLE);
        simpleItem(LOItems.LIGHT_BLUE_ACCENTED_WHITE_HEAVY_SADDLE);
        simpleItem(LOItems.LIGHT_GREY_ACCENTED_WHITE_HEAVY_SADDLE);
        simpleItem(LOItems.LIME_ACCENTED_WHITE_HEAVY_SADDLE);
        simpleItem(LOItems.MAGENTA_ACCENTED_WHITE_HEAVY_SADDLE);
        simpleItem(LOItems.ORANGE_ACCENTED_WHITE_HEAVY_SADDLE);
        simpleItem(LOItems.PINK_ACCENTED_WHITE_HEAVY_SADDLE);
        simpleItem(LOItems.PURPLE_ACCENTED_WHITE_HEAVY_SADDLE);
