...
public class OFrog extends Animal implements GeoEntity {
	...
	protected static final ResourceKey<LootTable> LOOT_TABLE = ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "entities/o_frog"));
	protected static final ResourceKey<LootTable> VANILLA_LOOT_TABLE = ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath("minecraft", "entities/frog"));
	protected static final ResourceKey<LootTable> TFC_LOOT_TABLE = ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath("tfc", "entities/frog"));
	@Override
