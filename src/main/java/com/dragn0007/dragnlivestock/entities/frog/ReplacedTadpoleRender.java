...
public class ReplacedTadpoleRender extends GeoReplacedEntityRenderer<Tadpole, ReplacedTadpole> {
	...
	@Override
	public void preRender(PoseStack poseStack, ReplacedTadpole entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int renderColor) {
