...
public class OChickenModel extends DefaultedEntityGeoModel<OChicken> {
    ...
    public OChickenModel() {
        super(ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "o_chicken"), true);
    }
    ...
    public enum Variant {
        ...
        LILAC(ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, default_path + "lilac.png")),
        ...
        VOID(ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, default_path + "void.png")),
    ...
    public enum SVariant {
        ...
        LILAC(ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, config_simplified_path + "lilac.png")),
        ...
        VOID(ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, config_simplified_path + "void.png")),
    ...
    public static final ResourceLocation ANIMATION = ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "animations/o_chicken.animation.json");
    public static final ResourceLocation BABY_MODEL = ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "geo/baby_o_chicken.geo.json");
    public static final ResourceLocation BABY_TEXTURE = ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "textures/entity/chicken/cream.png");
    public static final ResourceLocation SIMPLIFIED_MODEL = ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "geo/config_simplified/chicken.geo.json");
    public static final ResourceLocation SIMPLIFIED_ANIMATION = ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "animations/config_simplified/chicken.animation.json");
