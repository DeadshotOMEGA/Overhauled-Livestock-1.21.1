...
public class GoatFollowOwnerGoal extends Goal {
   public final FarmGoat tamable;
   ...
   public GoatFollowOwnerGoal(FarmGoat p_25294_, double v, float p_25296_, float p_25297_, boolean p_25298_) {
