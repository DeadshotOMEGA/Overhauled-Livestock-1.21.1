...
public class ORabbit extends TamableAnimal implements GeoEntity {
	...
	protected static final ResourceKey<LootTable> LOOT_TABLE = ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "entities/o_rabbit"));
	protected static final ResourceKey<LootTable> VANILLA_LOOT_TABLE = ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath("minecraft", "entities/rabbit"));
	protected static final ResourceKey<LootTable> TFC_LOOT_TABLE = ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath("tfc", "entities/rabbit"));
	@Override
	...
	static class RaidGardenGoal extends MoveToBlockGoal {
		...
		public boolean canUse() {
			if (this.nextStartTick <= 0) {
				if (!EventHooks.canEntityGrief(this.rabbit.level(), this.rabbit)) {
					return false;
				}
	...
	public void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(VARIANT_TEXTURE, ORabbitModel.Variant.BLACK.resourceLocation.toString());
		builder.define(OVERLAY_TEXTURE, ORabbitMarkingLayer.Overlay.NONE.resourceLocation.toString());
		builder.define(GENDER, 0);
		builder.define(DEWLAP, 0);
