...
public class GlowBerryMoobloomRender extends GeoEntityRenderer<GlowBerryMoobloom> {
    ...
    public GlowBerryMoobloomRender(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new GlowBerryMoobloomHarnessLayer(this));
    }

    @Override
    public void preRender(PoseStack poseStack, GlowBerryMoobloom entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int renderColor) {
