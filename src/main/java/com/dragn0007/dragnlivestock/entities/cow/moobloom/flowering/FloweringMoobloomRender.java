...
public class FloweringMoobloomRender extends GeoEntityRenderer<FloweringMoobloom> {
    ...
    public FloweringMoobloomRender(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new FloweringMoobloomHarnessLayer(this));
    }

    @Override
    public void preRender(PoseStack poseStack, FloweringMoobloom entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int renderColor) {
