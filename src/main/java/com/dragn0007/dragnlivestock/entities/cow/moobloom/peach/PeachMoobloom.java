...
public class PeachMoobloom extends AbstractMoobloom implements GeoEntity {
    ...
    public @NotNull InteractionResult mobInteract(Player player, @NotNull InteractionHand hand) {
        ...
        try {
            if (ModList.get().isLoaded("thatsjustpeachy") && itemStack.is(LOTags.Items.SHEARS) && (!isSheared() || regrowPlantsCounter >= LivestockOverhaulCommonConfig.SHEEP_WOOL_REGROWTH_TIME.get()) && !player.isShiftKeyDown()) {
    ...
    protected static final EntityDataAccessor<Integer> BRAND_TAG_COLOR = SynchedEntityData.defineId(PeachMoobloom.class, EntityDataSerializers.INT);
