...
public class CarrotMoobloomRender extends GeoEntityRenderer<CarrotMoobloom> {
    ...
    @Override
    public void preRender(PoseStack poseStack, CarrotMoobloom entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int renderColor) {
