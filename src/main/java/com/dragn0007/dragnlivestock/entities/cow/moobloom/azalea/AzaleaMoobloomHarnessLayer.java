...
@OnlyIn(Dist.CLIENT)
public class AzaleaMoobloomHarnessLayer extends GeoRenderLayer<AzaleaMoobloom> {
    public AzaleaMoobloomHarnessLayer(GeoRenderer<AzaleaMoobloom> entityRendererIn) {
