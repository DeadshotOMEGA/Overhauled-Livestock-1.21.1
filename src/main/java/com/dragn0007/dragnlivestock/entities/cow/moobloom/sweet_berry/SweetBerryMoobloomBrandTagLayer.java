...
@OnlyIn(Dist.CLIENT)
public class SweetBerryMoobloomBrandTagLayer extends GeoRenderLayer<SweetBerryMoobloom> {
    ...
    public SweetBerryMoobloomBrandTagLayer(GeoRenderer<SweetBerryMoobloom> entityRendererIn) {
