...
@OnlyIn(Dist.CLIENT)
public class PotatoMoobloomBrandTagLayer extends GeoRenderLayer<PotatoMoobloom> {
    ...
    public PotatoMoobloomBrandTagLayer(GeoRenderer<PotatoMoobloom> entityRendererIn) {
