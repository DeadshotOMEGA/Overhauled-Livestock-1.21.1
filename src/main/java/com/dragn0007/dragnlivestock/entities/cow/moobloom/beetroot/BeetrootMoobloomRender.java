...
public class BeetrootMoobloomRender extends GeoEntityRenderer<BeetrootMoobloom> {
    ...
    @Override
    public void preRender(PoseStack poseStack, BeetrootMoobloom entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int renderColor) {
