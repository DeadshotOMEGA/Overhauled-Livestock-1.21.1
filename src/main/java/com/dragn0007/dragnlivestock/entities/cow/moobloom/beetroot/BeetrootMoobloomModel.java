...
public class BeetrootMoobloomModel extends DefaultedEntityGeoModel<BeetrootMoobloom> {

    public BeetrootMoobloomModel() {
        super(ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "beetroot_moobloom"), true);
    }

    @Override
    public void setCustomAnimations(BeetrootMoobloom animatable, long instanceId, AnimationState<BeetrootMoobloom> animationState) {
    ...
    public enum Variant {
        DEFAULT(ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "textures/entity/moobloom/beet.png"));
