...
@OnlyIn(Dist.CLIENT)
public class AzaleaMoobloomBrandTagLayer extends GeoRenderLayer<AzaleaMoobloom> {
    ...
    public AzaleaMoobloomBrandTagLayer(GeoRenderer<AzaleaMoobloom> entityRendererIn) {
