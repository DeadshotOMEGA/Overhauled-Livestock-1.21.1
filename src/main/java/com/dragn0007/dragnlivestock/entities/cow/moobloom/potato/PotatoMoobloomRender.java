...
public class PotatoMoobloomRender extends GeoEntityRenderer<PotatoMoobloom> {
    ...
    public PotatoMoobloomRender(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new PotatoMoobloomHarnessLayer(this));
    }

    @Override
    public void preRender(PoseStack poseStack, PotatoMoobloom entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int renderColor) {
