...
@OnlyIn(Dist.CLIENT)
public class SweetBerryMoobloomHarnessLayer extends GeoRenderLayer<SweetBerryMoobloom> {
    public SweetBerryMoobloomHarnessLayer(GeoRenderer<SweetBerryMoobloom> entityRendererIn) {
