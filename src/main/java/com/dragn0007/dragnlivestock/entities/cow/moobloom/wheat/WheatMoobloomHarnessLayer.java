...
@OnlyIn(Dist.CLIENT)
public class WheatMoobloomHarnessLayer extends GeoRenderLayer<WheatMoobloom> {
    public WheatMoobloomHarnessLayer(GeoRenderer<WheatMoobloom> entityRendererIn) {
