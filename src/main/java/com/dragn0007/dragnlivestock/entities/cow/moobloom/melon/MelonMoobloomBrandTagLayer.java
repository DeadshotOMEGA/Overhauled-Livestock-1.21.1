...
@OnlyIn(Dist.CLIENT)
public class MelonMoobloomBrandTagLayer extends GeoRenderLayer<MelonMoobloom> {
    ...
    public MelonMoobloomBrandTagLayer(GeoRenderer<MelonMoobloom> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack poseStack, MelonMoobloom animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
