...
public class MelonMoobloomRender extends GeoEntityRenderer<MelonMoobloom> {
    ...
    public MelonMoobloomRender(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new MelonMoobloomHarnessLayer(this));
    }

    @Override
    public void preRender(PoseStack poseStack, MelonMoobloom entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int renderColor) {
