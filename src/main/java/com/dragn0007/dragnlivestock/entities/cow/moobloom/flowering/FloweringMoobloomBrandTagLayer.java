...
@OnlyIn(Dist.CLIENT)
public class FloweringMoobloomBrandTagLayer extends GeoRenderLayer<FloweringMoobloom> {
    ...
    public FloweringMoobloomBrandTagLayer(GeoRenderer<FloweringMoobloom> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack poseStack, FloweringMoobloom animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
