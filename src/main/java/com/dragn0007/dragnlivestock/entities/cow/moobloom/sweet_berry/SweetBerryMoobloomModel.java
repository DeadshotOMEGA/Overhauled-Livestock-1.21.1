...
public class SweetBerryMoobloomModel extends DefaultedEntityGeoModel<SweetBerryMoobloom> {
    ...
    public SweetBerryMoobloomModel() {
        super(ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "sweet_berry_moobloom"), true);
    }
    ...
    public enum Variant {
        DEFAULT(ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "textures/entity/moobloom/sweet_berry.png"));
