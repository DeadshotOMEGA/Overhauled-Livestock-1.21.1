...
@OnlyIn(Dist.CLIENT)
public class GlowBerryMoobloomBrandTagLayer extends GeoRenderLayer<GlowBerryMoobloom> {
    ...
    public GlowBerryMoobloomBrandTagLayer(GeoRenderer<GlowBerryMoobloom> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack poseStack, GlowBerryMoobloom animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
