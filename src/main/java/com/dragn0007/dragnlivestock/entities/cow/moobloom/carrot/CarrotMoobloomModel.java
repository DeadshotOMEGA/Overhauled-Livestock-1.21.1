...
public class CarrotMoobloomModel extends DefaultedEntityGeoModel<CarrotMoobloom> {
    ...
    public CarrotMoobloomModel() {
        super(ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "carrot_moobloom"), true);
    }
    ...
    public enum Variant {
        DEFAULT(ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "textures/entity/moobloom/carrot.png"));
