...
public class SweetBerryMoobloomMarkingLayer extends GeoRenderLayer<SweetBerryMoobloom> {
    public SweetBerryMoobloomMarkingLayer(GeoRenderer entityRendererIn) {
