...
@OnlyIn(Dist.CLIENT)
public class BeetrootMoobloomHarnessLayer extends GeoRenderLayer<BeetrootMoobloom> {
    public BeetrootMoobloomHarnessLayer(GeoRenderer<BeetrootMoobloom> entityRendererIn) {
