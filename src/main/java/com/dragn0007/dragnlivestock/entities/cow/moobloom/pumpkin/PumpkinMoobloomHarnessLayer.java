...
@OnlyIn(Dist.CLIENT)
public class PumpkinMoobloomHarnessLayer extends GeoRenderLayer<PumpkinMoobloom> {
    public PumpkinMoobloomHarnessLayer(GeoRenderer<PumpkinMoobloom> entityRendererIn) {
