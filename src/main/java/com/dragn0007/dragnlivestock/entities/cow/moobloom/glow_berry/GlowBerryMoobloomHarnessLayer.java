...
@OnlyIn(Dist.CLIENT)
public class GlowBerryMoobloomHarnessLayer extends GeoRenderLayer<GlowBerryMoobloom> {
    public GlowBerryMoobloomHarnessLayer(GeoRenderer<GlowBerryMoobloom> entityRendererIn) {
