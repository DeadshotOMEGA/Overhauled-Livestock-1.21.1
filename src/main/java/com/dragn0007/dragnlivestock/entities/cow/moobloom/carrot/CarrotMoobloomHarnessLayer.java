...
@OnlyIn(Dist.CLIENT)
public class CarrotMoobloomHarnessLayer extends GeoRenderLayer<CarrotMoobloom> {
    public CarrotMoobloomHarnessLayer(GeoRenderer<CarrotMoobloom> entityRendererIn) {
