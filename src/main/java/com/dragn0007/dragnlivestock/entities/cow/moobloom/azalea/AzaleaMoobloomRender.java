...
public class AzaleaMoobloomRender extends GeoEntityRenderer<AzaleaMoobloom> {
    ...
    public AzaleaMoobloomRender(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new AzaleaMoobloomHarnessLayer(this));
    }

    @Override
    public void preRender(PoseStack poseStack, AzaleaMoobloom entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int renderColor) {
