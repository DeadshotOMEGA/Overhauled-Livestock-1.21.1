...
@OnlyIn(Dist.CLIENT)
public class CarrotMoobloomBrandTagLayer extends GeoRenderLayer<CarrotMoobloom> {
    ...
    public CarrotMoobloomBrandTagLayer(GeoRenderer<CarrotMoobloom> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack poseStack, CarrotMoobloom animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
