...
public class MelonMoobloomModel extends DefaultedEntityGeoModel<MelonMoobloom> {
    ...
    public MelonMoobloomModel() {
        super(ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "melon_moobloom"), true);
    }
    ...
    public enum Variant {
        DEFAULT(ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "textures/entity/moobloom/melon.png"));
