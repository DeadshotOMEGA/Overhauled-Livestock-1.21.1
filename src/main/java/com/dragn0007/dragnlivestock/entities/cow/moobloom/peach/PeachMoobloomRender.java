...
public class PeachMoobloomRender extends GeoEntityRenderer<PeachMoobloom> {
    ...
    public PeachMoobloomRender(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new PeachMoobloomHarnessLayer(this));
    }

    @Override
    public void preRender(PoseStack poseStack, PeachMoobloom entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int renderColor) {
