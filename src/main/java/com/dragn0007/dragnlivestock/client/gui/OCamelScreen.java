...
public class OCamelScreen extends AbstractContainerScreen<OCamelMenu> {
    ...
    public void renderBg(GuiGraphics graphics, float f, int i, int j) {
        ...
        if (this.oCamel.hasChest()) {
            graphics.blit(CAMEL_INVENTORY_LOCATION, x + 79, y + 17, 0, this.imageHeight, 90, 54);
        }

//        if (this.oCamel.canWearShoes()) {
//            graphics.blit(CAMEL_INVENTORY_LOCATION, x + 7, y + 53, 54, this.imageHeight + 54, 18, 18);
//        }

        if (this.oCamel.isFemale()) {
            if (this.oCamel.isSnipped()) {
                graphics.blit(CAMEL_INVENTORY_LOCATION, x + 161, y + 9, 107, this.imageHeight + 54, 8, 8);
            } else {
        ...
        if (this.oCamel.isMale()) {
            if (this.oCamel.isSnipped()) {
                graphics.blit(CAMEL_INVENTORY_LOCATION, x + 161, y + 9, 115, this.imageHeight + 54, 8, 8);
            } else {
