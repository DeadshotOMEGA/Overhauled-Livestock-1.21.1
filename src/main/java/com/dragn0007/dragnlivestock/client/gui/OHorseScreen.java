...
public class OHorseScreen extends AbstractContainerScreen<OHorseMenu> {
    ...
    public void renderBg(GuiGraphics graphics, float f, int i, int j) {
        ...
        if (this.oHorse.isFemale()) {
            if (this.oHorse.isSnipped()) {
                graphics.blit(HORSE_INVENTORY_LOCATION, x + 161, y + 9, 106, this.imageHeight + 54, 8, 8);
            } else {
        ...
        if (this.oHorse.isMale()) {
            if (this.oHorse.isSnipped()) {
                graphics.blit(HORSE_INVENTORY_LOCATION, x + 161, y + 9, 114, this.imageHeight + 54, 8, 8);
            } else {
    ...
    private String getBreedText(int breed) {
        switch (breed) {
            ...
            case 16: return "Connemara (Pony)";
            case 17: return "Haflinger (Coldblood)";
            case 18: return "Oldenburger (Warmblood)";
            case 19: return "Shetland (Pony)";
