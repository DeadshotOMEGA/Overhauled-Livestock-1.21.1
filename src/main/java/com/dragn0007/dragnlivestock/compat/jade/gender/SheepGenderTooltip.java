...
public class SheepGenderTooltip implements IEntityComponentProvider {

    public SheepGenderTooltip() {
    }

    @Override
    public void appendTooltip(ITooltip tooltip, EntityAccessor entityAccessor, IPluginConfig iPluginConfig) {
        OSheep animal = (OSheep)entityAccessor.getEntity();
        if (animal.isFemale()) {
    ...
    public ResourceLocation getUid() {
        return ResourceLocation.fromNamespaceAndPath(LivestockOverhaul.MODID, "sheep_gender_tooltip");
    }
