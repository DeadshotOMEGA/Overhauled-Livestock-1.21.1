...
public class LivestockOverhaulCommonConfig {
    ...
    public static final ModConfigSpec.BooleanValue REPLACE_SPAWN_EGG_ANIMALS;
    public static final ModConfigSpec.ConfigValue<Double> SPAWN_PREVENTION_PERCENT;
    public static final ModConfigSpec.BooleanValue REPLACE_HORSES;
    public static final ModConfigSpec.BooleanValue REPLACE_MULES;
    public static final ModConfigSpec.BooleanValue REPLACE_DONKEYS;
    public static final ModConfigSpec.BooleanValue REPLACE_COWS;
    public static final ModConfigSpec.BooleanValue REPLACE_CHICKENS;
    public static final ModConfigSpec.BooleanValue REPLACE_SHEEP;
    public static final ModConfigSpec.BooleanValue REPLACE_PIGS;
    public static final ModConfigSpec.BooleanValue REPLACE_LLAMAS;
    public static final ModConfigSpec.BooleanValue REPLACE_RABBITS;
    public static final ModConfigSpec.BooleanValue REPLACE_SALMON;
    public static final ModConfigSpec.BooleanValue REPLACE_COD;
    public static final ModConfigSpec.BooleanValue REPLACE_BEES;
    public static final ModConfigSpec.BooleanValue REPLACE_CAMELS;
    public static final ModConfigSpec.BooleanValue REPLACE_GOATS;
    public static final ModConfigSpec.BooleanValue REPLACE_FROGS;
    public static final ModConfigSpec.BooleanValue REPLACE_UNDEAD_HORSES;
    public static final ModConfigSpec.BooleanValue SPAWN_MOOBLOOMS;
    public static final ModConfigSpec.BooleanValue SPAWN_UNICORNS;
    public static final ModConfigSpec.BooleanValue GENDERS_AFFECT_BIPRODUCTS;
    public static final ModConfigSpec.BooleanValue GENDERS_AFFECT_BREEDING;
    public static final ModConfigSpec.BooleanValue ANIMALS_HERDING_ENABLED;
    public static final ModConfigSpec.ConfigValue<Integer> SHEEP_HERD_MAX;
    ...
    public static final ModConfigSpec.ConfigValue<Integer> CHICKEN_EGG_LAY_AMOUNT;
    public static final ModConfigSpec.ConfigValue<Integer> MILKING_COOLDOWN;
    public static final ModConfigSpec.ConfigValue<Integer> DAIRY_MILKING_COOLDOWN;
    public static final ModConfigSpec.ConfigValue<Integer> SHEEP_WOOL_REGROWTH_TIME;
    public static final ModConfigSpec.BooleanValue HORSE_HAIR_GROWTH;
    public static final ModConfigSpec.ConfigValue<Integer> HORSE_HAIR_GROWTH_TIME;
    public static final ModConfigSpec.BooleanValue RABBITS_POOP;
    public static final ModConfigSpec.ConfigValue<Integer> RABBIT_POOP_TIME;
    public static final ModConfigSpec.BooleanValue SPAWN_BY_BREED;
    public static final ModConfigSpec.BooleanValue EYES_BY_COLOR;
    public static final ModConfigSpec.BooleanValue OLD_HORSE_TURNING;
    public static final ModConfigSpec.BooleanValue UNICORN_BREEDING;
    public static final ModConfigSpec.BooleanValue UNDEAD_HORSE_DEATH;
    public static final ModConfigSpec.ConfigValue<Double> UNDEAD_HORSE_CHANCE;
    public static final ModConfigSpec.ConfigValue<Integer> DECOMPISITION_STAGE_TIME;
    public static final ModConfigSpec.BooleanValue GROUND_TIE;
    public static final ModConfigSpec.ConfigValue<Integer> MAX_PIG_BABIES;
    public static final ModConfigSpec.ConfigValue<Integer> MAX_RABBIT_BABIES;
    public static final ModConfigSpec.BooleanValue ALLOW_SHEEP_DYE;
    public static final ModConfigSpec.ConfigValue<Integer> MAX_DYED_SHEARS;
    public static final ModConfigSpec.BooleanValue ROOSTERS_FEND;
    public static final ModConfigSpec.ConfigValue<Integer> BASE_HORSE_SPRINT_TIME;
    ...
    public static final ModConfigSpec.BooleanValue ALLOW_HOLIDAY_EVENTS;
    public static final ModConfigSpec.BooleanValue CREATIVE_BRANDING;
    public static final ModConfigSpec.BooleanValue CREATIVE_SNIPPING;
    public static final ModConfigSpec.BooleanValue QUALITY;
    public static final ModConfigSpec.ConfigValue<Integer> MALE_COOLDOWN;
    public static final ModConfigSpec.ConfigValue<Integer> FEMALE_COOLDOWN;
    public static final ModConfigSpec.ConfigValue<Integer> BREED_CHANCE;
    public static final ModConfigSpec.ConfigValue<Integer> COAT_CHANCE;
    public static final ModConfigSpec.ConfigValue<Integer> MARKING_CHANCE;
    public static final ModConfigSpec.ConfigValue<Integer> OTHER_CHANCE;
    public static final ModConfigSpec.BooleanValue DEBUG_LOGS;
    public static final ModConfigSpec.ConfigValue<Double> COVERED_WAGON_SPEED_MULT;
    public static final ModConfigSpec.ConfigValue<Double> DOG_SLED_SPEED_MULT;
    public static final ModConfigSpec.ConfigValue<Double> GOODS_CART_SPEED_MULT;
    public static final ModConfigSpec.ConfigValue<Double> LIVESTOCK_WAGON_SPEED_MULT;
    public static final ModConfigSpec.ConfigValue<Double> LUMBER_WAGON_SPEED_MULT;
    public static final ModConfigSpec.ConfigValue<Double> MINING_CART_SPEED_MULT;
    public static final ModConfigSpec.ConfigValue<Double> TRANSPORT_CART_SPEED_MULT;
    public static final ModConfigSpec.ConfigValue<Double> PLOW_SPEED_MULT;
    public static final ModConfigSpec.ConfigValue<Double> MOWER_SPEED_MULT;
    public static final ModConfigSpec.ConfigValue<Double> COUPE_SPEED_MULT;
    public static final ModConfigSpec.ConfigValue<Double> CABRIOLET_SPEED_MULT;
    public static final ModConfigSpec.ConfigValue<Double> SLEIGH_SPEED_MULT;
    public static final ModConfigSpec.BooleanValue FAILSAFE_REPLACER;
